...
export function appStateLoad(): Promise<AppStateSnapshot> {
  return invokeCommand("app_state_load");
}
...
export function employeeRolePolicies(): Promise<RolePolicy[]> {
  return invokeCommand("employee_role_policies");
}
...
export function employeeStopTerminal(employeeId: string): Promise<Employee> {
  return invokeCommand("employee_stop_terminal", { employeeId });
}

export function employeeActivityList(): Promise<EmployeeActivity[]> {
  return invokeCommand("employee_activity_list");
}

export function employeeActivityGet(employeeId: string): Promise<EmployeeActivity> {
  return invokeCommand("employee_activity_get", { employeeId });
}

export function terminalSessionList(
  employeeId?: string | null,
): Promise<TerminalSessionRecord[]> {
  return invokeCommand("terminal_session_list", { employeeId });
}
...
export function terminalSessionStop(
  ...
  return invokeCommand("terminal_session_stop", { employeeId, sessionId });
}
...
export function terminalWrite(
  ...
  return invokeCommand("terminal_write", { employeeId, sessionId, input });
}
...
export function gitWorktreeRemoveForEmployee(employeeId: string): Promise<Employee> {
  return invokeCommand("git_worktree_remove_for_employee", { employeeId });
}

export function gitWorktreeStatusForEmployee(employeeId: string): Promise<WorktreeStatus> {
  return invokeCommand("git_worktree_status_for_employee", { employeeId });
}

export function gitWorktreeDiffForEmployee(employeeId: string): Promise<string> {
  return invokeCommand("git_worktree_diff_for_employee", { employeeId });
}

export function gitWorktreeReviewForEmployee(employeeId: string): Promise<WorktreeReview> {
  return invokeCommand("git_worktree_review_for_employee", { employeeId });
}
...
export function gitWorktreeLogForEmployee(
  ...
  return invokeCommand("git_worktree_log_for_employee", { employeeId, limit });
}

export function gitWorktreeHandoffPreflightForEmployee(
  employeeId: string,
): Promise<WorktreeHandoffPreflight> {
  return invokeCommand("git_worktree_handoff_preflight_for_employee", { employeeId });
}

export function gitWorktreeChangedFilesForEmployee(employeeId: string): Promise<string[]> {
  return invokeCommand("git_worktree_changed_files_for_employee", { employeeId });
}
...
export function gitWorktreeFileDiffForEmployee(
  ...
  return invokeCommand("git_worktree_file_diff_for_employee", { employeeId, path });
}
...
export function gitWorktreeStageFile(
  ...
  return invokeCommand("git_worktree_stage_file", { employeeId, path });
}
...
export function gitWorktreeUnstageFile(
  ...
  return invokeCommand("git_worktree_unstage_file", { employeeId, path });
}
...
export function gitWorktreeDiscardFileForEmployee(
  ...
  return invokeCommand("git_worktree_discard_file_for_employee", { employeeId, path });
}
...
export function gitWorktreeDeleteUntrackedFileForEmployee(
  ...
  return invokeCommand("git_worktree_delete_untracked_file_for_employee", { employeeId, path });
}
...
export function gitWorktreeCommitForEmployee(
  ...
  return invokeCommand("git_worktree_commit_for_employee", { payload: { employeeId, message } });
}

export function gitWorktreeApplyHandoffForEmployee(
  employeeId: string,
): Promise<WorktreeHandoffApplyResult> {
  return invokeCommand("git_worktree_apply_handoff_for_employee", {
...
export function gitWorktreeAbortHandoffForEmployee(
  ...
  return invokeCommand("git_worktree_abort_handoff_for_employee", { employeeId });
}
...
export function fsCreateFile(path: string, contents: string): Promise<FilePayload> {
  return invokeCommand("fs_create_file", { path, contents });
}
